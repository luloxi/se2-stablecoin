 ...
 * - Exogenous Collateral (wWTC & WETH)
 * - Dollar Pegged
 * - Algoritmically Stable
 *
 * Is is similar to DAI if DAI had no governance, no fees, and was only backed bty WETH and WBTC.
 *
...
contract DSCEngine is ReentrancyGuard {
    ...
    function mintDsc(uint256 amountDscToMint) external moreThanZero(amountDscToMint) nonReentrant {
        ...
        // if they minted too much ($15' DSC, $100 ETH)
    ...
    function getUsdValue(address token, uint256 amount) public view returns (uint256) {
        ...
        // (1000 * 1e8) * (1000 * 1e18)
        // To get more precision, we get both numbers to be 1e18, then divide by 1e18
